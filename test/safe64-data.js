...
const o1_ubj_j = "SV03F3T1e2kFaGVsbG9bU2kFd29ybGRTaRZkYXJrbmVzcyBteSBvbGQgZnJpZW5kXX0";
//const o1_ubj_p = "SV03F3T1e1NVBWhlbGxvW1NVBXdvcmxkU1UWZGFya25lc3MgbXkgb2xkIGZyaWVuZF19";
...
t.is(lib.encodeData(o1, {format: UBJ}), o1_ubj_j, 'encodeData(:format<UBJSON>)');
t.is(lib.encodeData(o1, {format: PHP}), o1_php, 'encodeData(:format<PHP>)');

t.isJSON(lib.decodeData(o1_json), o1, 'decode(s64json)');
t.isJSON(lib.decodeData(o1_ubj_j), o1, 'decode(s64ubjson)');
//t.isJSON(lib.decodeData(o1_ubj_p), o1, 'decode(s64ubjson<PHP>)');
