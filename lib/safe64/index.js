...
module.exports = class
{
  ...
  static urlize(string, opts={})
  {
    ...
    string = string.replaceAll('=', useTildes ? '~' : '');
  ...
  static deurlize(string, opts={})
  {
    ...
    return opts.stripHeader ? this.stripHeader(string) : string;
  }
  ...
  get $plugin()
  {
    const name = PLUGINS[this.encFormat];
  ...
  encode(data)
  {
    ...
    const encoded = this.$plugin.encode.call(this, data);

    if (typeof encoded !== S)
    {
      throw new Error("serialization of data failed");
    }
  ...
  decode(string)
  {
    ...
    return this.$plugin.decode.call(this, opts);
  } // decode()
