...
/**
 * Convert a `WordArray` object into a byte array.
 * 
 * @param {WordArray} wordArray - The input object.
 * @param {boolean} [typed=false] Return a typed array? 
 * @returns {(Array|Uint8Array)} Format depends on `typed` parameter.
 */
exports.wordToByteArray = function(wordArray, typed=false) 
{
  ...
  return typed ? Uint8Array.from(byteArray) : byteArray;
}
